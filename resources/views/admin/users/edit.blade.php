                    ...
                    <div class="panel-body">
                      @if($user->active)
                           <form action="{{ route('usuarios.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="row">
                                <div class="col-lg-3">
                                  <img src="{{ (count($user->getMedia('profile'))) ? $user->getMedia('profile')->first()->getUrl() : '/img/default_avatar.png' }}" alt="avatar" class="img-responsive" style="max-height:200px;border-radius:200px" data-container="body" data-toggle="popover" data-placement="top" data-content="Cargar imagen..." id="img--upload">
